  ...
  return (
    ...
    >
      ...
      <header className="flex items-center justify-between gap-3 p-4 bg-white shadow-sm">
        ...
        <h1 className="min-w-0 text-2xl font-bold sm:text-3xl lg:text-4xl">Categoria de bonos</h1>
      </header>
      <div className="flex-1 overflow-auto p-4 z-10">
        <div className="w-full">
          <div className="bg-white shadow-sm sm:rounded-lg">
            <div className="text-gray-900 my-3 flex items-center justify-end">
              {allowedRoles.createBonusCategory.includes(role) && <ModalCreateCategoryBono />}
            </div>
            <Table
              className="overflow-auto"
              dataSource={categoriesBonus.map((categoryBonus) => ({
                ...categoryBonus,
