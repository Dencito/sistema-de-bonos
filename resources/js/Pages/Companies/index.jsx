...
const LazyModalCreateCompany = lazy(
    () => import('@/Components/Companies/ModalCreateCompany')
);
const LazyModalDeleteCompany = lazy(
    () => import('@/Components/Companies/ModalDeleteCompany')
);
const LazyModalEditCompany = lazy(
    () => import('@/Components/Companies/ModalEditCompany')
);
const LazyModalViewBranchesCompany = lazy(
    () => import('@/Components/Companies/ModalViewBranchesCompany')
);
const LazyModalViewCompany = lazy(
    () => import('@/Components/Companies/ModalViewCompany')
);
...
const columns = [
    ...
    },
    {
        ...
        render: (_, company) => (
            <div
                className={`${
                    (company?.status?.name === 'Activo' && 'bg-green-300') ||
                    (company?.status?.name === 'Inactivo' && 'bg-red-200') ||
                    (company?.status?.name === 'En revisión' &&
                        'bg-orange-300') ||
