...
export default function ModalViewCompany({ data }) {
  ...
  const validateRutNumbersLegalRepresentative = (_, value) => {
    if (
      ...
      const { rutNumbersLegalRepresentative, rutDvLegalRepresentative } = form.getFieldsValue([
    ...
    >
      ...
      >
        {countries?.map((country) => (
          <Select.Option key={country?.phone_code} value={country?.phone_code}>
  ...
  const prefixSelectorContact = (
    <Form.Item
      initialValue={data?.prefixContact}
      name="prefixContact"
      rules={[{ required: true, message: getValidationRequiredMessage }]}
      noStyle
    >
  ...
  return (
    <>
      ...
      >
        <Form.Item initialValue={data?.creationDate} name="creationDate" label="Fecha de creacion">
          <Input disabled />
        </Form.Item>
        <Form.Item
        ...
        <div className="flex gap-3">
          <Form.Item
            ...
            rules={[
              ...
              {
                pattern: /^[0-9]+$/,
                message: getValidationNumbersMessage,
              },
          ...
          <Form.Item
            ...
            rules={[
              ...
              {
                pattern: /^[0-9kK]{1}$/,
                message: 'El campo solo tiene permitido, Números y K',
              },
              { validator: validateRutNumbers },
            ]}
          >
        ...
        <div className="flex gap-5">
          ...
          >
            <Select
              onChange={() => setCountry(form?.getFieldsValue()?.companyAddressCountry)}
              showSearch
