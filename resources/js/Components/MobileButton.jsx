...
export default function MobileButton({ role, roles }) {
  ...
  return (
    <>
      <button onClick={toggleMenu} className="lg:hidden p-2 border border-gray-300 rounded-md">
      ...
      >
        <nav className="space-y-2 p-4 mt-10 z-30">
          <button onClick={toggleMenu} className="absolute top-5 right-5 text-red-600">
            <CircleX size={40} />
          </button>
