...
import { Form, DatePicker, Modal, Select, Button, Spin } from 'antd';
    ...
    <>
      ...
      <Modal
        ...
        footer={[
          ...
          <Button key="submit" type="primary" loading={loading} onClick={handleCreateDoubleBonuses}>
          ...
          <Form form={form} layout="vertical">
            <div className="space-y-4">
              <p className="mb-4 text-gray-600">
                Esta función creará bonos dobles (basados en la categoría de bono de cada usuario)
                para todos los jugadores de la sucursal seleccionada.
              </p>
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: getValidationRequiredMessage('La sucursal'),
                  },
                ]}
              >
                <Select
              ...
              <div className="p-3 text-sm text-blue-800 bg-blue-50 rounded border border-blue-200">
                <strong>Nota:</strong> Se crearán bonos dobles para todos los jugadores (role_id =
                6) que tengan asignada la sucursal seleccionada. El monto del bono será el doble del
                monto base de la categoría de bono de cada jugador.
              </div>
            </div>
          </Form>
        </Spin>
